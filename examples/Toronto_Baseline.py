...
phase_length_ring1 = [9, 32, 16, 46]
phase_length_ring2 = [15, 26, 20, 42]
sim.create_signal_nema({'id': 1,
                        'lanes': [[seg1.lanes[0]],
                                  ...
                                  [seg2.lanes[0]],
                                  seg4.lanes[1:3]],
                        'phase_length_ring1': phase_length_ring1,
                        'phase_length_ring2': phase_length_ring2,
                        'yellow_time': 3,
                        'all_red_time': 1,
                        })
...
#creating detectors
sim.create_detector(1, {'id':1, 'type':10, 'x':2, 'length':2, 'pulling_freq': 30})
sim.create_detector(2, {'id':2, 'type':10, 'x':2, 'length':2, 'pulling_freq': 30})
sim.create_detector(3, {'id':3, 'type':10, 'x':2, 'length':2, 'pulling_freq': 30})
sim.create_detector(4, {'id':4, 'type':10, 'x':2, 'length':2, 'pulling_freq': 30})
